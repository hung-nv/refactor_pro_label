...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
         ...
         */
        $table = $this->create_table_swissup_prolabels_label($installer);
        ...
        /**
          ...
          */
        $table = $this->create_table_swissup_prolabels_index($installer);
    ...
    private function create_table_swissup_prolabels_label($installer) {
    ...
    private function create_table_swissup_prolabels_index($installer) {
